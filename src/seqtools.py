...
class SequenceTools(object):
    ...
    @classmethod
    def get_all_codons_as_arrays(cls, base_order='ATCG'):
        arrs = {}
        for cod in SequenceTools.codon2protein_.keys():
            arrs[cod.upper()] = SequenceTools.convert_dna_str_to_arr(cod, base_order=base_order)
        return arrs
